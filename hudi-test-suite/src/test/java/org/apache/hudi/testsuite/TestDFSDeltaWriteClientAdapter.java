...
import org.apache.hudi.testsuite.reader.DeltaInputType;
import org.apache.hudi.testsuite.utils.TestUtils;
import org.apache.hudi.testsuite.writer.AvroFileDeltaInputWriter;
import org.apache.hudi.testsuite.writer.DFSDeltaWriterAdapter;
import org.apache.hudi.testsuite.writer.DeltaInputWriter;
import org.apache.hudi.testsuite.writer.DeltaOutputMode;
import org.apache.hudi.testsuite.writer.DeltaWriterAdapter;
import org.apache.hudi.testsuite.writer.DeltaWriterFactory;
import org.apache.hudi.testsuite.writer.DeltaWriteStats;
...
public class TestDFSDeltaWriteClientAdapter extends UtilitiesTestBase {
  ...
  public void setup() throws Exception {
    super.setup();
    schemaProvider = new FilebasedSchemaProvider(Helpers.setupSchemaOnDFS("test-suite", "complex-source.avsc"),
        jsc);
  }
